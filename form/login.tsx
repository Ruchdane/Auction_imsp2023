  ...
  return (
    <div className="text-primary flex flex-col justify-center items-center h-full gap-6 max-w-60">
      ...
      <div className="flex flex-col items-center gap-4">
        ...
        <div>
          <Input placeholder="Password" value={passwordField} onChange={e => setPasswordField(e.target.value)} />
        ...
        <div className="flex flex-col items-center gap-2">
          ...
          <span>Don't have an account? <a className="ml-2" href="#">Signup</a></span>    
        </div>
      </div>
    </div>
  );
